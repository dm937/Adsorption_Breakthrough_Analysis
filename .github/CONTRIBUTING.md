...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`RCCS-CaptureTeam/Adsorption_Breakthrough_Analysis`](https://github.com/RCCS-CaptureTeam/Adsorption_Breakthrough_Analysis)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/Adsorption_Breakthrough_Analysis.git`
...
```shell
$ git remote add RCCS-CaptureTeam https://github.com/RCCS-CaptureTeam/Adsorption_Breakthrough_Analysis.git
```
